...
import com.head.picker.view.ClipImageView;
...
public class ClipImageActivity extends Activity
{
        ...
        Intent data)
    {
        ...
        if (data != null && requestCode == mRequestCode)
        {
            ...
            Bitmap bitmap = ImageUtil
                .decodeSampledBitmapFromFile(this, images.get(0), 720, 1080);
            if (bitmap != null)
            {
    ...
    private void confirm(Bitmap bitmap)
    {
        ...
        if (StringUtils.isNotEmptyString(imagePath))
        {
            ...
            intent.putStringArrayListExtra(ImageSelector.SELECT_RESULT,
                selectImages);
    ...
    {
        Intent intent =
            new Intent(fragment.getActivity(), ClipImageActivity.class);
        intent.putExtra(ImageSelector.KEY_CONFIG, config);
