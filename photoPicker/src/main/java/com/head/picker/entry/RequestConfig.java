...
/**   
*
* 类名称：RequestConfig.java <br/>
* 类描述：封装请求参数<br/>
* 创建人：shuwen <br/>
* 创建时间：2020-08-27 09:36 <br/>
* @version 
*/
public class RequestConfig implements Parcelable
{
    ...
    public static final Creator<RequestConfig> CREATOR =
        new Creator<RequestConfig>()
        {
            @Override
