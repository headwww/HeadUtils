package com.head.picker.adapter;
...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ViewHolder>
{
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        ...
        {
            View view =
                mInflater.inflate(R.layout.adapter_images_item, parent, false);
            return new ViewHolder(view);
        }
        else
        {
            View view =
                mInflater.inflate(R.layout.adapter_camera, parent, false);
            return new ViewHolder(view);
        }
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position)
    {
        if (getItemViewType(position) == TYPE_IMAGE)
        {
            ...
            Glide.with(mContext)
                .load(isAndroidQ ? image.getUri() : image.getPath())
            ...
            holder.ivGif
                .setVisibility(image.isGif() ? View.VISIBLE : View.GONE);
    ...
    public Image getFirstVisibleImage(int firstVisibleItem)
    {
        if (mImages != null && !mImages.isEmpty())
        {
            ...
            {
                return mImages
                    .get(firstVisibleItem > 0 ? firstVisibleItem - 1 : 0);
            }
            else
            {
    ...
    private void setItemSelect(ViewHolder holder, boolean isSelect)
    {
        ...
        {
            holder.ivSelectIcon
                .setImageResource(R.drawable.icon_image_un_select);
