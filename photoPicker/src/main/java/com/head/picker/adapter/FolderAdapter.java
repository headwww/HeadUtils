    ...
    extends RecyclerView.Adapter<FolderAdapter.ViewHolder>
{
    ...
    public void onBindViewHolder(final ViewHolder holder, int position)
    {
        ...
        holder.ivSelect
            .setVisibility(mSelectItem == position ? View.VISIBLE : View.GONE);
        if (images != null && !images.isEmpty())
        {
            holder.tvFolderSize.setText(
                mContext.getString(R.string.selector_image_num, images.size()));
            Glide.with(mContext)
                .load(isAndroidQ ? images.get(0).getUri()
        ...
        {
            holder.tvFolderSize
                .setText(mContext.getString(R.string.selector_image_num, 0));
