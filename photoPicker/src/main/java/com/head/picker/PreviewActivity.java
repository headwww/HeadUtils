...
import com.head.picker.adapter.ImagePagerAdapter;
...
import com.head.picker.view.MyViewPager;
...
public class PreviewActivity extends AppCompatActivity
{
    ...
    public static void openActivity(Activity activity, ArrayList<Image> images,
                                    ArrayList<Image> selectImages, boolean isSingle, int maxSelectCount,
                                    int position)
    {
        tempImages = images;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        Bitmap selectBitmap = ImageUtil.getBitmapFromVectorDrawable(this,R.drawable.icon_image_select);
//        Bitmap selectBitmap = BitmapFactory.decodeResource(resources,
//                R.drawable.icon_image_select);
        mSelectDrawable = new BitmapDrawable(resources, selectBitmap);
        mSelectDrawable
            .setBounds(0, 0, selectBitmap.getWidth(), selectBitmap.getHeight());
        Bitmap unSelectBitmap = ImageUtil.getBitmapFromVectorDrawable(this,R.drawable.icon_image_un_select);

//        Bitmap unSelectBitmap = BitmapFactory.decodeResource(resources,
//            R.drawable.icon_image_un_select);
        mUnSelectDrawable = new BitmapDrawable(resources, unSelectBitmap);
        mUnSelectDrawable.setBounds(0,
            0,
            unSelectBitmap.getWidth(),
            unSelectBitmap.getHeight());
    ...
    private void initView()
    {
        ...
        RelativeLayout.LayoutParams lp =
            (RelativeLayout.LayoutParams)rlTopBar.getLayoutParams();
    ...
    private void initViewPager()
    {
        ...
        adapter
            .setOnItemClickListener(new ImagePagerAdapter.OnItemClickListener()
            {
                @Override
    ...
    private void showBar()
    {
        ...
        rlTopBar.postDelayed(new Runnable()
        {
            ...
            public void run()
            {
                if (rlTopBar != null)
                {
                    ObjectAnimator animator = ofFloat(rlTopBar,
                        "translationY",
                        rlTopBar.getTranslationY(),
                        0).setDuration(300);
    ...
    private void hideBar()
    {
        ...
        ObjectAnimator animator = ObjectAnimator
            .ofFloat(rlTopBar, "translationY", 0, -rlTopBar.getHeight())
            .setDuration(300);
        animator.addListener(new AnimatorListenerAdapter()
        {
            @Override
    ...
    {
        tvSelect.setCompoundDrawables(
            mSelectImages.contains(image) ? mSelectDrawable : mUnSelectDrawable,
            null,
            null,
            null);
