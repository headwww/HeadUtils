...
import com.head.picker.ClipImageActivity;
import com.head.picker.ImageSelectorActivity;
...
public class ImageSelector
{
    ...
    /**
     * 是否是来自于相机拍照的图片， 只有本次调用相机拍出来的照片，返回时才为true。 当为true时，图片返回当结果有且只有一张图片。
     */
    ...
    public static class ImageSelectorBuilder
    {
        ...
        public void start(Activity activity, int requestCode)
        {
            ...
            else
            {
                ImageSelectorActivity
                    .openActivity(activity, requestCode, config);
            }
        }
        ...
        public void start(Fragment fragment, int requestCode)
        {
            ...
            {
                ImageSelectorActivity
                    .openActivity(fragment, requestCode, config);
            }
        }
